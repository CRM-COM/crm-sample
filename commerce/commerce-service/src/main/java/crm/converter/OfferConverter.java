...
@Mapper(componentModel = "spring", uses = { OfferPriceConverter.class, PromotionConverter.class,
        OfferEntitlementConverter.class, OfferGlobalizationConverter.class, OfferFeaturesConverter.class })
